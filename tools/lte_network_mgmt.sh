...
function man_help() {
    ...
    echo '                    Rename the LTE Modem connection to "Cellular Modem"'
    echo ''
    echo '        -l | --lte_priority'
    echo '                    Set network connection priority to the Cellular Modem'
    echo ''
    echo '        -o | --other_priority'
    echo '                    Set network connection priority to other connection than Cellular Modem'
    echo ''
    echo '        -h | --help'
